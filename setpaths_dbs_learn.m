...
paths.code = 'C:\docs\code'; 
    paths.code_dbs_multi = [paths.code, filesep, 'dbs_learn']; 
    paths.code_analysis = [paths.code_dbs_multi, filesep, 'analysis'];
    paths.annot = [paths.code_analysis, filesep, 'annot']; % small annotation files
    paths.config = [paths.code_dbs_multi, filesep, 'config']; 
...
if ~isfolder(paths.data)
 ...
 paths_to_add =  {paths.code_dbs_multi;...
     [paths.code_analysis];...
     [paths.annot];...
     [paths.code_dbs_multi, filesep, 'util'];...
    [paths.code_dbs_multi, filesep, 'stimuli'];...
    [paths.code_dbs_multi, filesep, 'config'];...
    [paths.code_dbs_multi, filesep, 'NIMH_daqtoolbox_(Apr-7-2016)'];... % needed for sending beacon
