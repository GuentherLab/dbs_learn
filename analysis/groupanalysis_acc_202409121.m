...
op.plot_sub_training_timecourse = 1; 
op.plot_all_learning_curve_fits = 1;
op.plot_early_train_acc_on_vs_off_fits = 1; 
...
if op.plot_sub_training_timecourse
    ...
    for isub = 1:nsubs
        ...
        for iphase = 1:n_train_phases
            ...
            htitle = title([thissub '...' thisphase '..... trial-window size = ' num2str(acc_trials_plot_op.windowsize)],'Interpreter','none');
        end
    end
end
