...
%% params
%%%% best quantitative result is with stimnormlate, divide_by off, op.trainphase_half_ntrials = 50

%%%% does not yet affect bars, only timecourse
op.divide_by_trial_baseline  = 0; 
op.divide_by_chan_baseline = 0;

op.stimnormlate = 0; % same as divide by trial baseline.... delete
   ...
   resptab = resp(:,{'sub','chan'});
    ...
    for ichan = 1:nchans
        ...
        for ihalf = 1:2
            ...
            if op.stimnormlate
                fhlh{ihalf,'resp'}{1}.tc{ichan} = fhlh{ihalf,'resp'}{1}.tc{ichan} ./ repmat(abs(fhlh{ihalf,'resp'}{1}{ichan,'base'}{1}), 1, size(fhlh{ihalf,'resp'}{1}.tc{ichan},2)); 
    ...
    for ihalf = 1:2
        ...
        % % % % % % % % % % % % % % % % % if op.divide_by_trial_baseline 
        % % % % % % % % % % % % % % % % %     % normalize (divide) magnitude by baseline in each trial
        % % % % % % % % % % % % % % % % %     tc_all_chans_trials = tc_all_chans_trials ./ abs(cell2mat(fhlh{ihalf,'resp'}{1}.base));
        % % % % % % % % % % % % % % % % %                 % tc_all_chans_trials = tc_all_chans_trials ./ cell2mat(fhlh{ihalf,'resp'}{1}.base);
        % % % % % % % % % % % % % % % % % 
        % % % % % % % % % % % % % % % % % elseif op.divide_by_chan_baseline 
        % % % % % % % % % % % % % % % % %     tc_all_chans_trials = [];
